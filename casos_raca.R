...
dados_status <- table(dados_gerais$RACA_COR)
dados_status21 <- table(dados_gerais2021$RACA_COR)

#separar data da confirmação
#2020
dados_classificacao <- dados_gerais[,c("DATA_DA_NOTIFICACAO", "RACA_COR", "STATUS")]
...
#2021
dados_classificacao2021 <- dados_gerais2021[,c("DATA_DA_NOTIFICACAO", "RACA_COR", "STATUS")]
...
dados2 <- table(dados$data_status, dados$RACA_COR)
...
view(dados4)
glimpse(dados4)
names(dados4) <- c("Mês", "Amarela", "Branca", "Ignorado","Indígena", "Parda", "Preta")
nomes <- names(dados4)
glimpse(dados4)
...
scatter_plot_interativo <- plot_ly() %>%
  layout(
    title = "Número de Casos de COVID-19 por Raça/Cor",
...
scatter_plot_interativo <- scatter_plot_interativo %>%
  add_trace(
    data = dados4,
    x = ~Mês,
    y = ~`Amarela`,  # Substitua 'Série 1' pelo nome da sua primeira série
    name = "Amarela",
    type = "scatter",
    mode = "lines",
    line = list(color = "blue"),
    text = ~paste("Mês: ", Mês, "<br>Casos: ", `Amarela`),  # Substitua 'Série 1' conforme necessário
    hoverinfo = "text"
  )
...
scatter_plot_interativo <- scatter_plot_interativo %>%
  add_trace(
    data = dados4,
    x = ~Mês,
    y = ~`Branca`,  # Substitua 'Série 2' pelo nome da sua segunda série
    name = "Branca",
    type = "scatter",
    mode = "lines",
    line = list(color = "yellow"),  # Cor da segunda série
    text = ~paste("Mês: ", Mês, "<br>Casos: ", `Branca`),  # Substitua 'Série 2' conforme necessário
    hoverinfo = "text"
  )
...
scatter_plot_interativo <- scatter_plot_interativo %>%
  add_trace(
    data = dados4,
    x = ~Mês,
    y = ~`Indígena`,  # Substitua 'Série 2' pelo nome da sua segunda série
    name = "Indígena",
    type = "scatter",
    mode = "lines",
    line = list(color = "grey"),  # Cor da segunda série
    text = ~paste("Mês: ", Mês, "<br>Casos: ", `Indígena`),  # Substitua 'Série 2' conforme necessário
    hoverinfo = "text"
  )
...
scatter_plot_interativo <- scatter_plot_interativo %>%
  add_trace(
    data = dados4,
    x = ~Mês,
    y = ~`Parda`,  # Substitua 'Série 2' pelo nome da sua segunda série
    name = "Parda",
    type = "scatter",
    mode = "lines",
    line = list(color = "red"),  # Cor da segunda série
    text = ~paste("Mês: ", Mês, "<br>Casos: ", `Parda`),  # Substitua 'Série 2' conforme necessário
    hoverinfo = "text"
  )
...
scatter_plot_interativo <- scatter_plot_interativo %>%
  add_trace(
    data = dados4,
    x = ~Mês,
    y = ~`Preta`,  # Substitua 'Série 2' pelo nome da sua segunda série
    name = "Preta",
    type = "scatter",
    mode = "lines",
    line = list(color = "black"),  # Cor da segunda série
    text = ~paste("Mês: ", Mês, "<br>Casos: ", `Preta`),  # Substitua 'Série 2' conforme necessário
    hoverinfo = "text"
  )
